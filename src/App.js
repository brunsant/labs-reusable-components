...
import {
  CookieAstyled,
  CookieButton,
} from "components/CookieAlert/CookieAstyled";
// import { CookieAlert } from "components/CookieAlert/CookieAlert";

export const App = () => {
  return (
    <div>
      <CookieAstyled cookieText="We use cookies to provide you with a better service and for promotional purposes. By continuing to use this site, you consent to our use of cookies as discribed in our cookie policy" />
